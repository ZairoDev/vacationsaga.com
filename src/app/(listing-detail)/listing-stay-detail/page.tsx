                        ...
                        >
                          <div className="rounded-xl border border-slate-700">
                            <a href={item} target="_blank">
                              ...
                              /> */}
                              <Image src={item} alt="" className="w-64 h-64 rounded-xl lg:w-72 lg:h-72"/>
                            </a>
                          </div>
                        </div>
                      ))}
        ...
        <header className="rounded-md sm:rounded-xl h-[60%]">
          <div className="relative grid grid-cols-3 sm:grid-cols-4 gap-1 sm:gap-2 ">
            <div className="col-span-2 row-span-3 sm:row-span-2 relative rounded-md sm:rounded-xl overflow-hidden">
              ...
              /> */}
              <Image src={allImages[0]} alt="" className=" object-cover w-full h-full"/>
            </div>
            {allImages
              .filter((_, i) => i >= 1 && i < 5)
              .map((item, index) => (
                <div className="aspect-w-4 aspect-h-3 sm:aspect-w-6 sm:aspect-h-5 rounded-xl" key={index}>
                  ...
                  /> */}
                  <Image src={allImages[index]} alt="" className="object-cover rounded-xl sm:rounded-xl w-44 h-44 "/>
                </div>
              ))}
            <button
